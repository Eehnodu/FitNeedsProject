...
public class CommuDelVO {
	...
	public int getComm_views() {
		return comm_views;
	}

	public void setComm_views(int comm_views) {
	...
	public CommuDelVO(int comm_idx, String comm_title, String comm_content, String comm_file, String created_at,
			int comm_likes, int comm_views, String mem_id) {
		this.comm_idx = comm_idx;
		this.comm_title = comm_title;
		this.comm_content = comm_content;
		this.comm_file = comm_file;
